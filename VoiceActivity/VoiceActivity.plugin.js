	...
	(() => {
		...
		var __webpack_modules__ = {
			...
			252: (module, __webpack_exports__, __webpack_require__) => {
				...
				var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2__);
				var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_1___default());
				___CSS_LOADER_EXPORT___.push([module.id, ".VoiceActdivity-modalactivityitem-modalActivity{padding:16px}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-header{width:100%;min-width:0;margin-bottom:8px;display:flex;justify-content:space-between;color:var(--header-secondary);font-weight:700;text-transform:uppercase;font-family:var(--font-display);font-size:12px;line-height:16px}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body{display:flex;align-items:center}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-text{margin-left:10px;color:var(--text-normal);font-size:14px;line-height:18px;overflow:hidden;flex:1 1 auto}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-text>div,.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-text>h3{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-text>h3{font-weight:500;font-family:var(--font-display)}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer{margin-left:20px;display:flex}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-button{height:32px;min-height:32px;width:100%;display:flex;justify-content:center;align-items:center;padding:2px 16px;border-radius:3px;background-color:var(--button-secondary-background);transition:background-color .17s ease,color .17s ease;color:#fff;font-size:14px;line-height:16px;font-weight:500;user-select:none}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-button:hover{background-color:var(--button-secondary-background-hover)}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-button:active{background-color:var(--button-secondary-background-active)}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-button:disabled{background-color:var(--button-secondary-background-disabled);opacity:.5;cursor:not-allowed}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer>div[aria-label]{width:32px;margin-left:8px}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-joinWrapper .VoiceActdivity-modalactivityitem-joinButton{min-width:32px;max-width:32px;padding:0}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-joinWrapper .VoiceActdivity-modalactivityitem-joinButton:disabled{pointer-events:none}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-body .VoiceActdivity-modalactivityitem-buttonContainer .VoiceActdivity-modalactivityitem-joinWrapperDisabled{cursor:not-allowed}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-members{display:block;position:absolute;top:20px;right:16px}.VoiceActdivity-modalactivityitem-modalActivity .VoiceActdivity-modalactivityitem-hasOverflow :nth-child(3){background-color:var(--background-tertiary)}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					modalActivity: "VoiceActdivity-modalactivityitem-modalActivity",
					header: "VoiceActdivity-modalactivityitem-header",
					body: "VoiceActdivity-modalactivityitem-body",
					text: "VoiceActdivity-modalactivityitem-text",
					buttonContainer: "VoiceActdivity-modalactivityitem-buttonContainer",
					button: "VoiceActdivity-modalactivityitem-button",
					joinWrapper: "VoiceActdivity-modalactivityitem-joinWrapper",
					joinButton: "VoiceActdivity-modalactivityitem-joinButton",
					joinWrapperDisabled: "VoiceActdivity-modalactivityitem-joinWrapperDisabled",
					members: "VoiceActdivity-modalactivityitem-members",
					hasOverflow: "VoiceActdivity-modalactivityitem-hasOverflow"
				};
				bundlebd_styles__WEBPACK_IMPORTED_MODULE_0__.Z._load(___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___.locals, {
					_content: ___CSS_LOADER_EXPORT___.toString()
			...
			806: (module, __webpack_exports__, __webpack_require__) => {
				...
				var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2__);
				var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_1___default());
				___CSS_LOADER_EXPORT___.push([module.id, ".VoiceActdivity-voiceicon-icon{height:20px;width:20px;min-width:20px;border-radius:50%;background-color:var(--background-floating);cursor:pointer}.VoiceActdivity-voiceicon-icon:hover{background-color:var(--background-tertiary)}.VoiceActdivity-voiceicon-icon svg{padding:3px;color:var(--interactive-normal)}.VoiceActdivity-voiceicon-iconCurrentCall{background-color:var(--status-positive)}.VoiceActdivity-voiceicon-iconCurrentCall:hover{background-color:var(--button-positive-background)}.VoiceActdivity-voiceicon-iconCurrentCall svg{color:#fff}.VoiceActdivity-voiceicon-iconLive{height:16px;border-radius:16px;background-color:var(--status-danger);color:#fff;font-size:12px;line-height:16px;font-weight:600;font-family:var(--font-display);text-transform:uppercase}.VoiceActdivity-voiceicon-iconLive:hover{background-color:var(--button-danger-background)}.VoiceActdivity-voiceicon-iconLive>div{padding:0 6px}.VoiceActdivity-voiceicon-tooltip .VoiceActdivity-voiceicon-header{display:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.VoiceActdivity-voiceicon-tooltip .VoiceActdivity-voiceicon-subtext{display:flex;flex-direction:row;margin-top:3px}.VoiceActdivity-voiceicon-tooltip .VoiceActdivity-voiceicon-subtext>div{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.VoiceActdivity-voiceicon-tooltip .VoiceActdivity-voiceicon-tooltipIcon{min-width:16px;margin-right:3px;color:var(--interactive-normal)}.VoiceActdivity-voiceicon-iconContainer{margin-left:auto}.VoiceActdivity-voiceicon-iconContainer .VoiceActdivity-voiceicon-icon{margin-right:8px}.VoiceActdivity-voiceicon-iconContainer .VoiceActdivity-voiceicon-iconLive{margin-right:8px}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					icon: "VoiceActdivity-voiceicon-icon",
					iconCurrentCall: "VoiceActdivity-voiceicon-iconCurrentCall",
					iconLive: "VoiceActdivity-voiceicon-iconLive",
					tooltip: "VoiceActdivity-voiceicon-tooltip",
					header: "VoiceActdivity-voiceicon-header",
					subtext: "VoiceActdivity-voiceicon-subtext",
					tooltipIcon: "VoiceActdivity-voiceicon-tooltipIcon",
					iconContainer: "VoiceActdivity-voiceicon-iconContainer"
				};
				bundlebd_styles__WEBPACK_IMPORTED_MODULE_0__.Z._load(___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___.locals, {
					_content: ___CSS_LOADER_EXPORT___.toString()
			...
			701: (module, __webpack_exports__, __webpack_require__) => {
				...
				var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2__);
				var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_2___default()(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_1___default());
				___CSS_LOADER_EXPORT___.push([module.id, ".VoiceActdivity-voicepopoutsection-popoutSection{margin-bottom:16px}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-header{margin-bottom:8px;color:var(--header-secondary);font-size:12px;line-height:16px;font-family:var(--font-display);font-weight:700;text-transform:uppercase}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body{display:flex;flex-direction:row}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body .VoiceActdivity-voicepopoutsection-text{margin:auto 10px;color:var(--text-normal);font-size:14px;line-height:18px;overflow:hidden}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body .VoiceActdivity-voicepopoutsection-text>div,.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body .VoiceActdivity-voicepopoutsection-text>h3{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body .VoiceActdivity-voicepopoutsection-text>h3{font-family:var(--font-display);font-weight:500}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-body>:last-child{padding:12px 0;margin-left:auto}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-hasOverflow>:last-child>div>:last-child{background-color:var(--background-tertiary)}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper{display:flex;flex:0 1 auto;flex-direction:row;flex-wrap:nowrap;justify-content:flex-start;align-items:stretch;margin-top:12px}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-button{height:32px;min-height:32px;width:100%;display:flex;justify-content:center;align-items:center;padding:2px 16px;border-radius:3px;background-color:var(--button-secondary-background);transition:background-color .17s ease,color .17s ease;color:#fff;font-size:14px;line-height:16px;font-weight:500;user-select:none}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-button:hover{background-color:var(--button-secondary-background-hover)}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-button:active{background-color:var(--button-secondary-background-active)}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-button:disabled{background-color:var(--button-secondary-background-disabled);opacity:.5;cursor:not-allowed}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper>div[aria-label]{width:32px;margin-left:8px}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-joinWrapper .VoiceActdivity-voicepopoutsection-joinButton{min-width:32px;max-width:32px;padding:0}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-joinWrapper .VoiceActdivity-voicepopoutsection-joinButton:disabled{pointer-events:none}.VoiceActdivity-voicepopoutsection-popoutSection .VoiceActdivity-voicepopoutsection-buttonWrapper .VoiceActdivity-voicepopoutsection-joinWrapperDisabled{cursor:not-allowed}", ""]);
				___CSS_LOADER_EXPORT___.locals = {
					popoutSection: "VoiceActdivity-voicepopoutsection-popoutSection",
					header: "VoiceActdivity-voicepopoutsection-header",
					body: "VoiceActdivity-voicepopoutsection-body",
					text: "VoiceActdivity-voicepopoutsection-text",
					hasOverflow: "VoiceActdivity-voicepopoutsection-hasOverflow",
					buttonWrapper: "VoiceActdivity-voicepopoutsection-buttonWrapper",
					button: "VoiceActdivity-voicepopoutsection-button",
					joinWrapper: "VoiceActdivity-voicepopoutsection-joinWrapper",
					joinButton: "VoiceActdivity-voicepopoutsection-joinButton",
					joinWrapperDisabled: "VoiceActdivity-voicepopoutsection-joinWrapperDisabled"
				};
				bundlebd_styles__WEBPACK_IMPORTED_MODULE_0__.Z._load(___CSS_LOADER_EXPORT___.toString());
				const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(___CSS_LOADER_EXPORT___.locals, {
					_content: ___CSS_LOADER_EXPORT___.toString()
