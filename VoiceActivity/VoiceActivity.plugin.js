    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        const plugin = (Plugin, Library) => {
            ...
            function VoiceIcon(props) {
                ...
                const showHiddenUsers = BdApi.Plugins.isEnabled("ShowHiddenChannels") && !getSHCBlacklist().includes(guild?.id) && BdApi.Plugins.get("ShowHiddenChannels").instance.settings.general.showVoiceUsers;
