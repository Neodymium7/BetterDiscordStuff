...
export const peopleListItemClass = expectModule(byProps("peopleListItem"), {
	name: "People List Classes",
	fallback: { peopleListItem: "peoplelistitem" },
}).peopleListItem;

export const privateChannelClass = expectModule(byProps("privateChannelsHeaderContainer"), {
